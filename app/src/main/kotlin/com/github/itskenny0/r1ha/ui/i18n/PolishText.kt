...
private val polishExact = mapOf(
    ...
    "HA ASSIST" to "ASYSTENT HA",
    "Type below or tap one of these prompts to start." to "Wpisz poniżej lub stuknij podpowiedź, aby rozpocząć.",
    ...
    "SCREEN MANAGER" to "MENEDŻER EKRANU",
    "RECENT EVENTS" to "OSTATNIE ZDARZENIA",
    "No hardware events yet. The generic tablet provider emits lifecycle events at app start." to "Brak zdarzeń sprzętowych. Domyślny dostawca tabletu wysyła zdarzenia przy starcie.",
